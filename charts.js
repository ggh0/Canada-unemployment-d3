// Below reads in data from CSV, and creates line chart and heatmap using the data
    ...
    function showLineChart() {
        ...
        lineChart.append("rect").attr("height",lineChartHeight).attr("width",17).attr("y",0).attr("x",xScale(new Date(1981,06,01))).attr("fill","lightgrey")
        lineChart.append("rect").attr("height",lineChartHeight).attr("width",26).attr("y",0).attr("x",xScale(new Date(1990,03,01))).attr("fill","lightgrey")
        lineChart.append("rect").attr("height",lineChartHeight).attr("width",8).attr("y",0).attr("x",xScale(new Date(2008,10,01))).attr("fill","lightgrey")
        lineChart.append("rect").attr("height",lineChartHeight).attr("width",8).attr("y",0).attr("x",xScale(new Date(2020,03,01))).attr("fill","lightgrey")
